...
public class BlockmessBlockImp implements BlockmessBlock {
	...
	public static final ISerializer<BroadcastValue> serializer = new ISerializer<>() {
		...
		public void serialize(BroadcastValue broadcastValue, ByteBuf out) throws IOException {
			BlockmessBlockImp block = (BlockmessBlockImp) broadcastValue;
	...
	public BlockmessBlockImp(int inherentWeight, List<UUID> prevRefs, ContentList contentList,
	...
	private BlockmessBlockImp(int inherentWeight, List<UUID> prevRefs, ContentList contentList,
