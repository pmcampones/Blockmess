...
public interface BlockmessChain extends Ledger, ComposableOperationMapper {
	...
	/**
	 * Queries whether this Chain's load is too low to warrant its existence.
	 */
	 ...
	 * forking many many temporary Chains and thus stopping the system from linearizing blocks to be delivered to the
	 * application.</p>
