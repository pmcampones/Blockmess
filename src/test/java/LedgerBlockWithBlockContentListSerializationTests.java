...
public class LedgerBlockWithBlockContentListSerializationTests {

    public LedgerBlockWithBlockContentListSerializationTests() {
        ProtoPojo.pojoSerializers.put(BlockContentList.ID, BlockContentList.serializer);
    ...
    void shouldSerializeMinimalBlock() throws Exception {
        ...
        BlockContent<SlimTransaction> blockContent = new BlockContentList<>(emptyList());
    ...
    void shouldSerializeWithSeveralTxs() throws Exception {
        ...
        BlockContent<SlimTransaction> blockContent = new BlockContentList<>(txs);
        LedgerBlock<BlockContent<SlimTransaction>, PoETDRandProof> cpy =
                serializeLedgerBlock(prevRefs, blockContent);
