...
public class SimpleBlockContentList<E extends IndexableContent>
    ...
    public SimpleBlockContentList(List<E> contentLst) {
        super(ID);
    ...
    public static final ISerializer<ProtoPojo> serializer = new ISerializer<>() {
        ...
        public void serialize(ProtoPojo protoPojo, ByteBuf out) throws IOException {
            SimpleBlockContentList<IndexableContent> blockContentList = (SimpleBlockContentList) protoPojo;
        ...
        public ProtoPojo deserialize(ByteBuf in) throws IOException {
            ...
            return new SimpleBlockContentList<>(contentLst);
        }
